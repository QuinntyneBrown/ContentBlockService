...
const template = require("./headline-content-block-item-embed.component.html");
const styles = require("./headline-content-block-item-embed.component.scss");

export class HeadlineContentBlockItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new HeadlineContentBlockDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new HeadlineContentBlockEdit(this.entity));
    }
    ...
    public entity: HeadlineContentBlock;
}

customElements.define(`ce-headline-content-block-item-embed`,HeadlineContentBlockItemEmbedComponent);
