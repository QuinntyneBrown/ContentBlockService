...
const template = require("./content-block-item-embed.component.html");
const styles = require("./content-block-item-embed.component.scss");

export class ContentBlockItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new ContentBlockDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new ContentBlockEdit(this.entity));
    }
    ...
    public entity: ContentBlock;
}

customElements.define(`ce-content-block-item-embed`,ContentBlockItemEmbedComponent);
