...
const template = require("./call-to-action-content-block-item-embed.component.html");
const styles = require("./call-to-action-content-block-item-embed.component.scss");

export class CallToActionContentBlockItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new CallToActionContentBlockDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new CallToActionContentBlockEdit(this.entity));
    }
    ...
    public entity: CallToActionContentBlock;
}

customElements.define(`ce-call-to-action-content-block-item-embed`,CallToActionContentBlockItemEmbedComponent);
