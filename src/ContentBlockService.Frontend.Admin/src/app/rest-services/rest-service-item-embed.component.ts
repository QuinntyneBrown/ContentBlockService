...
const template = require("./rest-service-item-embed.component.html");
const styles = require("./rest-service-item-embed.component.scss");

export class RestServiceItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new RestServiceDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new RestServiceEdit(this.entity));
    }
    ...
    public entity: RestService;
}

customElements.define(`ce-rest-service-item-embed`,RestServiceItemEmbedComponent);
