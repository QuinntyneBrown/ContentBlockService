...
using ContentBlockService.Features.DigitalAssets.UploadHandlers;
using System;
...
namespace ContentBlockService.Features.DigitalAssets
{
    public class AzureBlobStorageDigitalAssetCommand
    {
        ...
        {
            public AzureBlobStorageDigitalAssetHandler(ContentBlockServiceContext context, ICache cache, Lazy<IAzureBlobStorageConfiguration> lazyConfiguration)
            {
                _context = context;
                _cache = cache;
