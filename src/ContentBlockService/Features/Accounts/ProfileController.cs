...
using static ContentBlockService.Features.Accounts.AddOrUpdateProfileCommand;
using static ContentBlockService.Features.Accounts.GetProfilesQuery;
using static ContentBlockService.Features.Accounts.GetProfileByIdQuery;
using static ContentBlockService.Features.Accounts.RemoveProfileCommand;
